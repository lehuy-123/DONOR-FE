...
function extractBlock(startMarker) {
    ...
    for (let i = startLine; i < lines.length; i++) {
        ...
        // Sometimes the closing div is on a new line or there are fragments
...
if (chatBlock && bulletinBlock) {
    ...
    fs.writeFileSync('c:/Users/Tinh Tam/Videos/DONOR3/DONOR/frontend/src/views/DonorView.jsx', lines.join('\n'));
